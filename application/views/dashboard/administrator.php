                        ...
                        <div class="span12">
                                ...
                                <div class="span7 infobox-container">
                                    <div class="infobox infobox-green  ">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number"><?php echo $projects_detail["total"]?></span>
                                    ...
                                    <div class="infobox infobox-blue  ">
                                        ...
                                        <div class="infobox-data">
                                            <span class="infobox-data-number"><?php echo $totalManagers?></span>
                                    ...
                                    <div class="infobox infobox-pink  ">
                                        ...
                                        <div class="infobox-data">
                                            ...
                                            <div class="infobox-content">Team Members</div>
                                        </div>
                            ...
                            <div class="row-fluid">
                                ...
                                <div class="table-header">
                                    Results for "Projects in action"
                                </div>
...
$(function() {
	...
	var data; 
    $.ajax({
	   url: '<?php echo base_url()?>account/prj_load',
	   dataType: 'json',
		  ...
		  $('.dialogs,.comments').slimScroll({
		      height: '300px'
				...
				$("#managers").dataTable({
            		...
            		"sAjaxSource" : "<?php echo base_url() ?>account/managers",
